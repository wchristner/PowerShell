...
[System.Windows.Forms.MessageBox]::Show(" ha ha This will Install the Ricoh Black and White Dockside printer on your computer. Once you click OK, it will run. It may take a minute to install. During that time you will see no screen activity until it finishes with the printer installation." , "Kinexus") 
