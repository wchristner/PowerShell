...
$PrinterIP = "192.168.144.80"
$PrinterPort = "9100"
$PrinterPortName = "IP_" + "$PrinterIP"
$DriverName = "RICOH PCL6 UniversalDriver V4.10"
$DriverPath = "\\bh-miworks-srv2\PrintDrivers\Powershell Printer Install\Kinexus Printer Drivers\Paw Paw BW"
$DriverInf = "\\bh-miworks-srv2\PrintDrivers\Powershell Printer Install\Kinexus Printer Drivers\Paw Paw BW\Paw Paw BW.inf"
$PrinterCaption = "PawPaw B/W"
