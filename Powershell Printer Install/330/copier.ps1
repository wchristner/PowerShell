...
[System.Windows.Forms.MessageBox]::Show("This will Install the 330 Color printer on your computer. Once you click OK, it will run. It may take a minute to install. During that time you will see no screen activity until it finishes with the printer installation." , "Kinexus") 
...
Start-Sleep -s 5
[System.Windows.Forms.MessageBox]::Show("Installation of 330 Color printer has completed! If you have any problems, please contact IT." , "Kinexus") 
}
